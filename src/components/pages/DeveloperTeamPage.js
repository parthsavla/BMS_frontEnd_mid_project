...
import TaskDisplayDeveloper from'./TaskDisplayDeveloper'
import {
  Link,
  Navigate  
...
export default function DeveloperTeamPage({sentData}) {
  ...
  const loadticketDevData = async() =>{
    try{
       const res = await axios.get("http://localhost:5000/api/loadDevTicket")
       .then((res)=>{
  ...
  const renderMenu = (
    ...
    >
      ...
      <Link to="/devAccountPage"><MenuItem onClick={handleMenuClose}>Completed Tasks</MenuItem></Link>
    </Menu>
  );
    ...
    <div className={classes.grow}>
      ...
      <Grid container alignItems="center" justifyContent="center">
        ...
        <div>
            ...
            <TaskDisplayDeveloper tdata = {ticketData}></TaskDisplayDeveloper>
            :
            <CircularProgress/>}
        </div>
    </div>
